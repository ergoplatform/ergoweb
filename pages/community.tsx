  ...
  return (
    <div>
      ...
      <Layout title={title}>
        ...
        <LazyInView rootMargin="200px 0px">{() => <Sigmanauts />}</LazyInView>
        ...
        <LazyInView rootMargin="200px 0px">{() => <ErgoFoundation />}</LazyInView>
        <LazyInView rootMargin="200px 0px">{() => <OurMission />}</LazyInView>
      </Layout>
    </div>
  );
}
