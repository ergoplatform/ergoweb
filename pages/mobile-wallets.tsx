      ...
      <Layout title={title}>
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <main className="mt-0 mx-auto max-w-7xl px-6 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                ...
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                    <a target="_blank" href="https://play.google.com/store/apps/details?id=org.ergoplatform.android" className="flex text-base font-medium rounded-2xl text-white md:text-lg">
                    <img src="/assets/google.svg" alt="" />
                    </a>
                    <a target="_blank" href="https://testflight.apple.com/join/MRyG2qfm" className="flex text-base font-medium rounded-2xl text-white md:text-lg ml-0 lg:ml-2 mt-4 lg:mt-0">
                ...
                <p className="mt-3 text-lg text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-lg lg:mx-0">
                    Sources available on <a className="text-red-500 dark:text-red-500" href="https://github.com/ergoplatform/ergo-wallet-android" target="_blank">GitHub</a>
                </p>
                </div>
            </main>
            </div>
            ...
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                ...
                <dt>
                    ...
                    <svg width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M20.75 0.28125H1.25C0.835156 0.28125 0.5 0.616406 0.5 1.03125V12.6562C0.5 13.0711 0.835156 13.4062 1.25 13.4062H10.1562V16.0312H6.125C5.91875 16.0312 5.75 16.2 5.75 16.4062V17.5312C5.75 17.6344 5.83437 17.7188 5.9375 17.7188H16.0625C16.1656 17.7188 16.25 17.6344 16.25 17.5312V16.4062C16.25 16.2 16.0813 16.0312 15.875 16.0312H11.8438V13.4062H20.75C21.1648 13.4062 21.5 13.0711 21.5 12.6562V1.03125C21.5 0.616406 21.1648 0.28125 20.75 0.28125ZM19.8125 11.7188H2.1875V1.96875H19.8125V11.7188Z" fill="white"/>
                    </svg>
                    </div>
                    <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Watch wallets</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500 dark:text-red-100">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8">
            ...
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500 dark:text-white">
                    Check out the <a className="text-red-500 dark:text-red-500" href="https://github.com/ergoplatform/ergo-wallet-app" target="_blank">GitHub</a> project.
                </dd>
                </div>
                ...
                <dt>
                    ...
                    <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Community backed</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500 dark:text-white">
                    Visit the <a className="text-red-500 dark:text-red-500" href="https://discord.gg/kj7s7nb" target="_blank">Ergo Discord</a> or <a className="text-red-500 dark:text-red-500" href="https://t.me/ergoplatform" target="_blank">Telegram</a> support group to get help.
                </dd>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8">
            ...
            <p className="pt-3 mb-1 lg:text-lg text-gray-100  text-sm">ERGO provides much. We are working to get more and more of its features available in the app. </p>
            <p className="lg:text-lg text-gray-100 text-sm">Be the first to get new features by joining the open beta on Google Play!         </p>

            <div className="sm:flex sm:justify-center  mt-10">
                <a target="_blank" href="https://play.google.com/store/apps/details?id=org.ergoplatform.android" className="flextext-base font-medium rounded-2xl text-white md:text-lg">
                <img src="/assets/google.svg" alt="" />
                </a>
                <a target="_blank" href="https://testflight.apple.com/join/MRyG2qfm" className="flex text-base font-medium rounded-2xl text-white md:text-lg ml-0 lg:ml-2 mt-4 lg:mt-0">
                <img src="/assets/appstore.svg" alt="" />
