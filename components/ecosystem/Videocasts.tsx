      ...
      {mods ? (
        ...
        >
          {props.chagingTheWorldProjects.map((post: any, i: number) => {
            const href = safeExternalUrl(post.attributes.url);
            return (
              <mods.SwiperSlide key={i} className="mb-20 lg:mt-20">
                <div className="flex flex-col lg:flex-row">
                  ...
                  <div className="mt-4 lg:ml-10 ml-0 lg:w-1/3">
                    ...
                    <p className="text-[14px] lg:text-[16px] text-[#666666] dark:text-[#666666] mb-4">
                    ...
                    <div className="-ml-4">
                      {href ? (
                        <a href={href} target="_blank" rel="noopener noreferrer">
                          <button
                            type="submit"
                            className="py-1 px-4 inline-flex whitespace-nowrap btn rounded-full text-white font-vinila-extended text-[14px] md:text-[16px] bg-brand-orange ml-4"
                          >
                            <span>
