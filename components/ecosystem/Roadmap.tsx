...
export default function Roadmap(props: Props) {
  const sections = [
    ...
    {
      name: <FormattedMessage defaultMessage="ECOSYSTEM" id="components.roadmap.section2.title" />,
      tag: 'up_next',
    },
    {
    ...
    {
      name: <FormattedMessage defaultMessage="UP NEXT" id="components.roadmap.section4.title" />,
      tag: 'this_year',
    },
  ];
  return (
