  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row justify-between">
        ...
        <div>
          <p className="font-subtitle-3-bold text-[#666666] dark:text-[#666666] mb-6 max-w-lg">
            <FormattedMessage
              defaultMessage="Available across popular exchanges and decentralized exchanges."
              id="components.exchanges.available"
            />
          </p>
          <p className="text-[#666666] dark:text-[#666666] max-w-lg">
            <FormattedMessage
      ...
      <div className="mt-6 grid grid-cols-2 gap-0.5 md:grid-cols-4 lg:mt-8">
        {filteredExchanges.map((exchange: any) => {
          const href = safeExternalUrl(exchange.attributes.url);
          if (!href) return null;
          return (
