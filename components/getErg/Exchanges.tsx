  ...
  return (
    <div className="max-w-[1300px] mx-auto py-12 px-4 lg:py-16 lg:px-4">
      <div className="flex flex-col md:flex-row">
        ...
        <div>
          <p className="font-subtitle-3-bold text-[#989898] dark:text-[#989898] mb-6">You can buy, sell and trade Ergo on a number of online platforms called exchanges.</p>
          <p className="text-[#989898] dark:text-[#989898]">Disclaimer: Exchanges provide highly varying degrees of safety, security, privacy, and control over your funds and information. Perform your own research and consider whether storage of your coins in a wallet would be a safer option.</p>
        </div>
      </div>
