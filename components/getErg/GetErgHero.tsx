  ...
  return (
    ...
    >
      <div className="flex flex-col xl:flex-row justify-between">
        <div className="lg:flex lg:flex-col lg:items-start lg:mb-40">
          <p className="text-black dark:text-white mb-4 font-bold" id="components.getErg.heroTitle">
            UNSTOPPABLE DEFI
          </p>
        ...
        <div className="overflow-x-auto lg:gap-4 gap-8 mt-10 no-scrollbar pb-10 grid grid-cols-2 md:grid-cols-4 grid-rows-2 md:grid-rows-1 ml-4">
          {cards.map((card: any, i: number) => (
            <Link key={i} href={card.url} className="cursor-pointer">
