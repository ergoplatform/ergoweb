      ...
      return {
        ...
        documents: _.map(items, function adjustDoc(doc) {
          return {
            ...
            url: doc.attributes.url == null ? doc.attributes.file.data?.attributes.url : doc.attributes.url,
          };
        })
      };
    }).value();
  ...
  return (
    <div className="max-w-[1300px] mx-auto p-4 mt-40">
      <div className="flex flex-col lg:flex-row mb-12">
        <a className="font-vinila-extended text-[48px] md:text-[96px] lg:w-2/3"><b>Documents</b></a>
        <div className="lg:w-1/3"><p className="text-[#989898] dark:text-[#989898]">Ergo takes a research-based approach and uses stable well-tested solutions to provide a robust platform for developers to build on for years to come. Most of Ergo solutions are formalized in papers presented at peer-reviewed conferences and have been widely discussed in the community.</p></div>
      </div>
