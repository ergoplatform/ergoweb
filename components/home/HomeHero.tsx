...
export default function HomeHero() {
  ...
  return (
    <div id="HomeHero" className="mt-0 md:mt-24 max-w-[1300px] mx-auto p-4 relative z-1">
      ...
      {renderVideo && (
        <div className="absolute -top-20 lg:-top-28 left-0 right-0 h-[400px] w-full object-cover md:h-auto md:object-contain md:w-full md:max-w-none md:scale-100 hidden md:block bg-transparent dark:bg-transparent pointer-events-none z-0 outline-none focus:outline-none focus-visible:outline-none overflow-hidden">
          <video
