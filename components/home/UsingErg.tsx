...
const cards = [
  {
    title: (
      <FormattedMessageFixed
        ...
        id="components.usingErg.MineIt.title"
      />
    ),
    text: (
      <FormattedMessageFixed
  ...
  },
  {
    title: (
      <FormattedMessageFixed
        ...
        id="components.usingErg.BuyIt.title"
      />
    ),
    text: (
      <FormattedMessageFixed
  ...
  },
  {
    title: (
      <FormattedMessageFixed
        ...
        id="components.usingErg.StoreIt.title"
      />
    ),
    text: (
      <FormattedMessageFixed
...
export default function UsingErg(props: Props) {
  return (
    <div id="UsingErg" className="max-w-[1300px] mx-auto py-12 px-4 lg:py-16 lg:px-4 relative" style={{zIndex:13}}>
      <div className="flex flex-col xl:flex-row justify-between">
        <div className="lg:flex lg:flex-col lg:justify-end lg:mb-44">
          ...
          <p className="text-[#989898] dark:text-[#989898] mt-6 max-w-xs">
            There is a rich ecosystem budding on of Ergo. Whether you
