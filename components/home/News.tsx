...
export default function News({
  ...
  return (
    <div className="mt-36 mb-14 md:mx-24 max-w-7xl p-4 flex flex-col lg:flex-row">
          ...
          <Swiper className="SwiperNews" pagination={{ dynamicBullets: true, }} modules={[Pagination]}>
            {news.data.map((post: any, i: number) => (
              <SwiperSlide key={i} className=''>
                <b><FormattedDate value={post.attributes.date} day="numeric" month="long" year="numeric" /></b>
